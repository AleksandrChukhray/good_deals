...
// Вывод ссылки
if ($j == $page) {
echo '<a style="color: #FF6347;" href="/market/cat-'.$_SESSION['fil_id'].'/page-'.$page.'">'
        . '<li style="background-color:#bc9de; border:1px solid #863de9; border-radius:10px; color:white">'.$j.'</li></a> ';
} else {

echo "<a style='color: #FF6347;' href='/market/cat-$_SESSION[fil_id]/page-$page' ><li style='display:table; margin-right:5px;
...
$per=6;
$pages_count = ceil($block_count_tovar_cat / $per); // Количество страниц
